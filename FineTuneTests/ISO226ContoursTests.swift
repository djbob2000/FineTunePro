...
struct LoudnessCompensatorHybridTests {
    ...
    @Test("At low volume, low exciter generates non-linear 3rd harmonic")
    func lowVolumeGeneratesLowHarmonics() {
        let sampleRate = 48000.0
        let processor = LoudnessCompensator(sampleRate: sampleRate)
        
        // System volume = 0.0 (maximum exciter intensity)
        ...
        #expect(magnitude3rdHarmonic > 0.001, "At 0% volume, 3rd harmonic should be generated by Low Exciter, got \(magnitude3rdHarmonic)")
    }
}
